...
class PascalDataLoader(object):
    ...
    def _parse_single_example(self, example_proto):
		context, sequence = tf.parse_single_sequence_example(
										...
										context_features={
										  ...
										  "category": tf.FixedLenFeature([], dtype=tf.int64),
										},
										sequence_features={
		...
		category = tf.cast(context["category"], tf.int32)
		reverse_caption = tf.reverse(caption, axis=[0])
		return image, caption, category, tf.size(caption)
    ...
    def _read_data(self, record_path, batch_size, phase='train', num_epochs=10):
        ...
        image, caption, category, seq_len = iterator.get_next()
        return image, caption, category, seq_len
